...
<head>
	...
	<link rel="stylesheet" type="text/css" href="researcherProfile(researcher view).css">
		...
		<div class="row" id="content">
			...
			<div class="row">
							  ...
							  <div class="panel panel-default">
							    ...
							    <div id="collapse1" class="panel-collapse collapse in">
							      <div class="panel-body">
							      	<img src="Images/Tour_Eiffel.jpg" width="250px" heght="250px">
							      	<br>
							      	<p>The Eiffel Tower (/ˈaɪfəl ˈtaʊ.ər/ EYE-fəl TOW-ər; French: tour Eiffel, pronounced [tuʁ‿ɛfɛl] About this sound listen) is a wrought iron lattice tower on the Champ de Mars in Paris, France. It is named after the engineer Gustave Eiffel, whose company designed and built the tower.
				...
				<div class="col-md-3">
					...
					<button type="button" class="btn btn-default"><i class="fa fa-envelope" aria-hidden="true"></i>  Edid Your Profile</button>
